...
<div class="app">
  <div class="sidebar" id="sidebar">
    ...
    <nav>
      <a class="nav-item" href="/#nuestros-productos">
      ...
      <a class="nav-item active" href="/dashboard">
        <!-- dashboard icon -->
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="3" width="8" height="8" rx="1.5" stroke="currentColor" stroke-width="1.2"/><rect x="13" y="3" width="8" height="5" rx="1.5" stroke="currentColor" stroke-width="1.2"/><rect x="13" y="10" width="8" height="11" rx="1.5" stroke="currentColor" stroke-width="1.2"/><rect x="3" y="13" width="8" height="8" rx="1.5" stroke="currentColor" stroke-width="1.2"/></svg>
        <span>Dashboard</span>
      </a>
      ...
      <a class="nav-item" href="#">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 7v10" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/><path d="M7 12h10" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
        <span>Transacciones</span>
      </a>

      <a class="nav-item" href="#">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="8" r="3" stroke="currentColor" stroke-width="1.2"/><path d="M5.5 20c1.5-2.8 4.3-4.5 6.5-4.5s5 1.7 6.5 4.5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
        <span>Usuarios</span>
      </a>
  ...
  <div class="main">
    <div class="topbar">
      ...
      <nav class="m-0 p-0 main-header navbar navbar-expand d-flex justify-content-between">
        <div class="dropdown">
